...
$sfxID = isset($_GET['sfxID']) && is_scalar($_GET['sfxID']) ? (int) $_GET['sfxID'] : 0;
$record = $app->customSfx()->downloadRecord($sfxID);
if ($record === null) {
...
header('Content-Disposition: inline; filename="' . $sfxID . '.ogg"');
