...
$recordLogin = static function (int $accountID, bool $success) use ($db, $loginTable, $ipHash): void {
    $query = $db->prepare(
        ...
        . ' (ipHash, accountID, success, attemptedAt) VALUES (:ipHash, :accountID, :success, :attemptedAt)'
    );
    $query->execute([
        ':ipHash' => $ipHash,
